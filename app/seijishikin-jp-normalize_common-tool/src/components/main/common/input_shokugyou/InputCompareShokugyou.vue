...
<template>
    ...
    <div class="one-line">
        ...
        <div class="right-area">
            <div class="form-group-vertical">
                ...
                <select v-model="inputShokugyouDto.gyoushu" @change="sendAllShokugyou" class="name-input">
                    <option value=""></option>
    ...
    <div class="one-line">
        ...
        <div class="right-area">
            <div class="form-group-vertical">
                <select v-model="inputShokugyouDto.yakushoku" @change="sendAllShokugyou" class="name-input">
        ...
        <div class="one-line">
            ...
            <div class="right-area">
                <div class="form-group-vertical">
                    ...
                    <div>
                        <span>法人番号:{{ props.editDto.houjinNo }}</span>
                        <span class="left-space">法人名称:{{ props.editDto.houjinName }}</span>
                        <span class="left-space">法人住所:{{ props.editDto.houjinAddress }}</span>
                    </div>
                </div>
            </div>
        </div>
