...
public class DecideXmlFileCharsetUtil {
     ...
     */
    public Charset practice(final Path path, final String keyWord) throws IOException {
    ...
    private boolean judge(final Path path, final String charsetName, final String keyWord) throws IOException {
